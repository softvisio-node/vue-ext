...
export default {
    ...
    "methods": {
        ...
        _ready ( e ) {
            ...
            cmp.setColumns( [
                ...
                },
                {
                    ...
                    "text": this.l10n( `Duration / call (ms)` ),
                    "width": 140,
                },
                {
                    "align": "right",
                ...
                },
                {
                    ...
                    "text": this.l10n( `Exceptions / call (%)` ),
                    "width": 140,
                },
                {
                    "width": 80,
                ...
                "widget": {
                    ...
                    "items": [
                        ...
                        },
                        {
                            ...
                            "tooltip": this.l10n( `Exceptions log` ),
        ...
        _setPeriod ( menuItem ) {
            ...
            this.$refs.periodButton.ext.setText( this.l10n( `Period` ) + ": " + menuItem.getText() );
