    ...
    "methods": {
        _createCpuUserChart ( cmp ) {
            ...
            chart.children.unshift( am5.Label.new( root, {
                "text": this.l10nd( `vue-ext`, `CPU (user) for the last 60 30 minutes` ),
                "fontSize": 12,
                "x": am5.percent( 50 ),
        ...
        _createCpuSystemChart ( cmp ) {
            ...
            // title
            chart.children.unshift( am5.Label.new( root, {
                "text": this.l10nd( `vue-ext`, `CPU (system) for the last 60 30 minutes` ),
                "fontSize": 12,
                "x": am5.percent( 50 ),
                "centerX": am5.percent( 50 ),
            } ) );
        ...
        _createMemoryUsedChart ( cmp ) {
            ...
            // title
            chart.children.unshift( am5.Label.new( root, {
                "text": this.l10nd( `vue-ext`, `Used memory (MB) for the last 60 30 minutes` ),
                "fontSize": 12,
                "x": am5.percent( 50 ),
                "centerX": am5.percent( 50 ),
            } ) );
        ...
        _createMemoryRssChart ( cmp ) {
            ...
            // title
            chart.children.unshift( am5.Label.new( root, {
                "text": this.l10nd( `vue-ext`, `RSS memory (MB) for the last 60 30 minutes` ),
                "fontSize": 12,
                "x": am5.percent( 50 ),
                "centerX": am5.percent( 50 ),
            } ) );
        ...
        _createFsUsedChart ( cmp ) {
            ...
            // title
            chart.children.unshift( am5.Label.new( root, {
                "text": this.l10nd( `vue-ext`, `FS used (MB) for the last 60 30 minutes` ),
                "fontSize": 12,
                "x": am5.percent( 50 ),
                "centerX": am5.percent( 50 ),
            } ) );
        ...
        async refresh () {
            ...
            const res = await this.$api.call( "development/monitoring/instances/get-instance-stats", this.record.id, "1 hour" );
