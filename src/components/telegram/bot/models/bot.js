...
export default Ext.define( null, {
    ...
    "fields": [
        ...
        // subscribed
        { "name": "total_subscribed_users_percent", "calculate": data => data.total_subscribed_users / data.total_users },
        ...
        // unsubscribed
        { "name": "total_unsubscribed_users_percent", "calculate": data => data.total_unsubscribed_users / data.total_users },
        ...
        // banned
        { "name": "total_banned_users_percent", "calculate": data => data.total_banned_users / data.total_users },
