export default Ext.define( "", {
    ...
    "proxy": {
        "api": {
            "read": "admin/api-call-log/read-api-method-access-log",
        },
    },
    ...
    "fields": [
        ...
        { "name": "status_label", "calculate": data => Ext.util.Format.label( data.status, data.status >= 200 && data.status < 300 ? "green" : "red" ) },
