<template>
    <ext-dialog :title="title" width="95%" height="95%" scrollable="true" closeAction="hide" layout="fit" viewModel="true">
        ...
        <ext-grid ref="grid" layout="fit" multicolumnSort="true" @ready="gridReady">
            <ext-column :text="i18nd(`vue-ext`, `Started`)" dataIndex="started" width="150" formatter='date("intl:dateStyle:short,timeStyle:short")'/>
            <ext-column :text="i18nd(`vue-ext`, `Finished`)" dataIndex="finished" width="150" formatter='date("intl:dateStyle:short,timeStyle:short")'/>
