<template>
    <ext-dialog title="Edit User Permissions" width="800" height="90%" closable="true" draggable="false" closeAction="hide" hideOnMaskTap="true" layout="fit" viewModel="true">
...
export default {
    ...
    "methods": {
        ...
        async setRecord ( record ) {
            ...
            const res = await this.$api.call( "admin/users/getPermissions", record.id );
        ...
        async submit () {
            ...
            const res = await this.$api.call( "admin/users/updatePermissions", this.record.id, permissions );
