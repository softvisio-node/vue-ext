<template>
    <ext-dialog title="Edit User Permissions" width="800" height="90%" displayed="true" closable="true" draggable="false" closeAction="hide" hideOnMaskTap="true" layout="fit" viewModel="true">
