<template>
    <ext-dialog title="Edit Token Permissions" width="800" height="400" displayed="true" closable="true" draggable="false" closeAction="hide" hideOnMaskTap="true" layout="fit" viewModel="true">
