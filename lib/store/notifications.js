...
export default class NotificationsStore extends Store {
    ...
    async reloadSettings () {
        const res = await this.$api.call( "account/notification/get-notifications-settings" );
        ...
        if ( !res.ok ) {
            ...
            this.telegramUsername = res.data.telegram_username;
            this.telegramBotUsername = res.data.telegram_bot_username;
    ...
    async setRead ( notifications ) {
        ...
        const res = await this.$api.call( "account/notification/set-read", notifications );
    ...
    async setReadAll () {
        const res = await this.$api.call( "account/notification/set-read-all" );
    ...
    async setUnread ( notifications ) {
        ...
        const res = await this.$api.call( "account/notification/set-unread", notifications );
    ...
    async setUnreadAll () {
        const res = await this.$api.call( "account/notification/set-unread-all" );
    ...
    async setDone ( notifications ) {
        ...
        const res = await this.$api.call( "account/notification/set-done", notifications );
    ...
    async setDoneAll () {
        ...
        const res = await this.$api.call( "account/notification/set-done-all" );
    ...
    async setUndone ( notifications ) {
        ...
        const res = await this.$api.call( "account/notification/set-undone", notifications );
    ...
    async setUndoneAll () {
        const res = await this.$api.call( "account/notification/set-undone-all" );
    ...
    async delete ( notifications ) {
        ...
        const res = await this.$api.call( "account/notification/delete", notifications );
    ...
    async deleteAll () {
        const res = await this.$api.call( "account/notification/delete-all" );
