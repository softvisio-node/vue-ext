...
export default class NotificationsStore extends Store {
    ...
    async reloadSettings () {
        const res = await this.$api.call( "notification/get-notifications-settings" );
    ...
    async setRead ( notifications ) {
        ...
        const res = await this.$api.call( "notification/set-read", notifications );
    ...
    async setReadAll () {
        const res = await this.$api.call( "notification/set-read-all" );
    ...
    async setUnread ( notifications ) {
        ...
        const res = await this.$api.call( "notification/set-unread", notifications );
    ...
    async setUnreadAll () {
        const res = await this.$api.call( "notification/set-unread-all" );
    ...
    async setDone ( notifications ) {
        ...
        const res = await this.$api.call( "notification/set-done", notifications );
    ...
    async setDoneAll () {
        ...
        const res = await this.$api.call( "notification/set-done-all" );
    ...
    async setUndone ( notifications ) {
        ...
        const res = await this.$api.call( "notification/set-undone", notifications );
    ...
    async setUndoneAll () {
        const res = await this.$api.call( "notification/set-undone-all" );
    ...
    async delete ( notifications ) {
        ...
        const res = await this.$api.call( "notification/delete", notifications );
    ...
    async deleteAll () {
        const res = await this.$api.call( "notification/delete-all" );
