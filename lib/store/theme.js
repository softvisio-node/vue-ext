...
const DEFAULT_THEME = {
    "base": process.env.APP_THEME_BASE,
    "accent": process.env.APP_THEME_ACCENT,
};

class ThemeRegistry extends Events {
    #theme;
...
window[Symbol.for( "THEME_REGISTRY" )] = new ThemeRegistry( { "maxListeners": Infinity } );
...
export default class extends Store {
    ...
    constructor () {
        ...
        if ( this.systemDarkMode == null ) {
            ...
            // user-defined dark mode is not set
                ...
                if ( process.env.APP_THEME_DARK_MODE === "auto" ) {
        ...
        // user-defined dark mode is not set
            ...
            if ( process.env.APP_THEME_DARK_MODE === "auto" ) {
                ...
                this.darkMode = process.env.APP_THEME_DARK_MODE === "true";
            }
        }
        else {
    ...
    #applyTheme ( theme ) {
        ...
        window[Symbol.for( "THEME_REGISTRY" )].theme = theme;
    }
}
