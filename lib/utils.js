...
export async function alert ( title, message, { width = 350, height = 200 } = {} ) {
    const iconCls = "fa-solid fa-triangle-exclamation fa-2xl";
...
export async function confirm ( title, message, { width = 350, height = 200, iconCls } = {} ) {
